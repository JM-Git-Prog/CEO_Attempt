...
_PROFILE_VALUES = (
    ...
    {
        "id": "v13-browser-game-r1",
        "interface_version": 13,
        "release_commit": None,
        "supersedes": "v12-photo-world-r1",
        "stages": {
            "plan": {
                "validation": "relationship-solver/v1",
                "placement": "explicit-semantic-relations/v1",
            ...
            "photo": {
                ...
                "pipeline": "photo-pipeline-orchestrator/v1",
                "comfyui_required": True,
                "compilation": "browser-glb-export/v1",
                "game_target": "browser_threejs",
            },
            "world": {
                "contract": "world-contract/v1",
                "commands": "semantic-command/v1",
        ...
        "source": "V13 embeds playable 3D world in browser via Three.js",
        "status": "experimental",
    },
    {
        "id": "v14-real-3d-mesh-r1",
        "interface_version": 14,
        "release_commit": None,
        "supersedes": "v13-browser-game-r1",
        "stages": {
            "plan": {
                "validation": "relationship-solver/v1",
                "placement": "explicit-semantic-relations/v1",
            ...
            "photo": {
                "source_type": "photo",
                "pipeline": "photo-pipeline-v14/v1",
                "comfyui_required": True,
                "mesh_generation": "hunyuan3d-v2.1",
                "mesh_fallback": "trellis2-4b",
                "depth_model": "depth-anything-3",
                "compilation": "browser-glb-viewer/v1",
                "game_target": "browser_threejs_gltf",
                "two_pass_materials": True,
                "asset_warehouse": True,
            },
            "world": {
                "contract": "world-contract/v1",
                "commands": "semantic-command/v1",
