...
def test_default_order_encodes_authority_gates_and_pass_order():
    ...
    assert names.index("blockout_approval") < names.index("object_isolation")
    assert names.index("object_isolation") < names.index("object_canon_approval")
    assert names.index("object_canon_approval") < names.index("mesh_generation")
