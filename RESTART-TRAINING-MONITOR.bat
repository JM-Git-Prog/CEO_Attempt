...
if "%FLYWHEEL_RUNNING%"=="0" start "flywheel-loop" /min cmd /c "cd /d "C:\Users\JohnM\My Applications\Kiro\CEO_Kiro\CEO_Attempt" && python bench\flywheel_loop.py >> bench\flywheel-console.txt 2>&1"
...
if "%FLYWHEEL_RUNNING%"=="1" if "%FLYWHEEL_BUSY%"=="0" start "flywheel-loop" /min cmd /c "cd /d "C:\Users\JohnM\My Applications\Kiro\CEO_Kiro\CEO_Attempt" && python bench\flywheel_loop.py >> bench\flywheel-console.txt 2>&1"
