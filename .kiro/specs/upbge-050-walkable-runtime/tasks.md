...
- [x] 1. API Probe and Discovery Infrastructure
...
- [x] 2. Component Source Templates (KX_PythonComponent)
  - [x] 2.1 Implement PlayerComponent source template (`src/upbge_runtime.py`)
  ...
  - [x] 2.2 Implement DoorComponent source template (`src/upbge_runtime.py`)
  ...
  - [x] 2.3 Write property test for movement direction relative to orientation (Property 2)
  ...
  - [x] 2.4 Write property test for mouse look delta with pitch clamping (Property 3)
  ...
  - [x] 2.5 Write property test for gravity force computation (Property 4)
  ...
  - [x] 2.6 Write property test for pause toggle idempotence (Property 5)
  ...
  - [x] 2.7 Write property test for movement round-trip (Property 6)
  ...
  - [x] 2.8 Write property test for door state toggle (Property 7)
  ...
  - [x] 2.9 Write property test for door rotation convergence (Property 8)
  ...
  - [x] 2.10 Write property test for interaction hit classification (Property 9)
  ...
  - [x] 2.11 Write property test for held object velocity direction (Property 10)
...
- [x] 4. Compile-Time Component Attachment (`_configure_runtime()` Update)
  - [x] 4.1 Implement `_embed_component_source()` function
  ...
  - [x] 4.2 Implement `_attach_component_050()` function
  ...
  - [x] 4.3 Implement `_configure_physics_050()` function
  ...
  - [x] 4.4 Implement `_configure_runtime_050()` orchestrator function
  ...
  - [x] 4.5 Write property test for interaction binding to component attachment (Property 11)
  ...
  - [x] 4.6 Write property test for text datablock embedding completeness (Property 12)
  ...
  - [x] 4.7 Write property test for graceful degradation save (Property 14)
...
- [x] 6. Smoke Validator Update
  - [x] 6.1 Implement updated smoke probe script (`src/assembler/smoke_probe_050.py`)
  ...
  - [x] 6.2 Update `src/smoke_validator.py` to use the new probe script
  ...
  - [x] 6.3 Write property test for validator correctness (Property 13)
  ...
  - [x] 6.4 Write property test for degradation reason codes (Property 15)
  ...
  - [x] 6.5 Write property test for module path ↔ text datablock consistency (Property 16)
  ...
  - [x] 6.6 Write property test for component source import restriction (Property 17)
...
- [x] 8. Auto-Launch and blenderplayer Integration
  - [x] 8.1 Update auto-launch to work with runtime_candidate from new compiler
...
- [x] 9. Integration Wiring and Final Verification
  - [x] 9.1 Wire probe → compile → validate → launch pipeline
  ...
  - [x] 9.2 Write integration test for full probe → compile → validate → launch flow
  ...
  - [x] 9.3 Write integration test against live UPBGE 0.50 binary
