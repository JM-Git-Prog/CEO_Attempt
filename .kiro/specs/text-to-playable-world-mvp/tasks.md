...
- [x] 10. Serialization and Contract Integrity
  ...
  - [x] 10.5 Write property test for canonical JSON format constraints (Property 15)
  ...
  - [x] 10.6 Write property test for deserialization validation errors (Property 16)
...
- [x] 14. Integration wiring and final verification
  ...
  - [x] 14.3 Write integration test for full MVP pipeline with mock LLM
  ...
  - [x] 14.4 Write property test for sidecar structured failure (Property 9)
