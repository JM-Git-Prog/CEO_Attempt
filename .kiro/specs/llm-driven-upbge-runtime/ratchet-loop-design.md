...
- 2026-07-22 18:24 CDT — ROOT CAUSE of comfyui_unavailable:URLError found and fixed: the local Comfy Desktop instance served its default port, not 8188; startup args now include `--port 8188` and the instance is switched/live. This wake should produce the first trial batch that actually reaches image generation. (The periodic-readiness-recheck improvement above just earned its priority.)
