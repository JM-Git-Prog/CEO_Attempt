...
- [x] 2. QA harness — inject into browser.py and build Python bridge
  ...
  - [x] 2.2 Implement QA bridge Python module for Playwright ↔ __qa protocol
  ...
  - [x] 2.3 Write unit tests for QA bridge serialization and error handling
...
- [x] 3. Checkpoint — Ensure QA harness integration works
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Visual regression — screenshot capture, pixelmatch, baselines
  - [x] 4.1 Implement screenshot capture module
  ...
  - [x] 4.2 Implement baseline manager with versioned golden baselines
  ...
  - [x] 4.3 Implement pixel diff module (pixelmatch wrapper)
  ...
  - [x] 4.4 Implement visual regression test module
  ...
  - [x] 4.5 Write property tests for filename encoding and threshold gate logic
...
- [x] 5. Scene validation — object count, positions, lighting, interactions
  - [x] 5.1 Implement scene validation test module
  ...
  - [x] 5.2 Implement lighting validation tests
  ...
  - [x] 5.3 Implement interaction testing
  ...
  - [x] 5.4 Write property tests for scene validation logic
...
- [x] 6. Accessibility — axe-core, focus, contrast, responsive, keyboard
  - [x] 6.1 Implement accessibility test module with axe-core integration
  ...
  - [x] 6.2 Implement focus trap validation for approval dialogs
  ...
  - [x] 6.3 Implement color contrast checks for HUD overlays
  ...
  - [x] 6.4 Implement screen reader announcement and responsive layout tests
  ...
  - [x] 6.5 Implement keyboard navigation alternative tests
  ...
  - [x] 6.6 Write property tests for accessibility assertion logic
...
- [x] 7. Checkpoint — Ensure PR fast tier passes
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. GPU infrastructure — ComfyUI health fix, real FLUX, artifact endpoints
  - [x] 8.1 Implement ComfyUI health check resilience with exponential backoff
  ...
  - [x] 8.2 Implement real FLUX generation E2E test
  ...
  - [x] 8.3 Implement generated artifact endpoint verification tests
  ...
  - [x] 8.4 Write property tests for health check retry and artifact validation
...
- [x] 9. Perceptual fidelity — SSIM, LPIPS, CLIP composite gate
  - [x] 9.1 Implement perceptual metrics computation module
  ...
  - [x] 9.2 Implement composite gate module
  ...
  - [x] 9.3 Implement perceptual fidelity test module
  ...
  - [x] 9.4 Write property tests for composite gate logic
...
- [x] 10. AI vision QA — qwen2.5vl semantic oracle
  - [x] 10.1 Implement vision oracle module
  ...
  - [x] 10.2 Implement vision QA test module
  ...
  - [x] 10.3 Write property tests for vision verdict structure and routing
...
- [x] 11. Checkpoint — Ensure nightly GPU tier passes
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12. VRAM resource scheduling integration
  - [x] 12.1 Extend Resource Arbiter with test-specific resource kinds
  ...
  - [x] 12.2 Implement VRAM scheduling in perceptual and vision test fixtures
  ...
  - [x] 12.3 Write unit tests for VRAM scheduling logic
    - Test lease acquisition and release timing
    - Test timeout behavior at 60s
    - Test sequential scheduling order enforcement
    - _Requirements: 21.1–21.5_

- [x] 13. Perceptual metric calibration support
  - [x] 13.1 Implement calibration run capability
  ...
  - [x] 13.2 Write unit tests for calibration computation
    - Test mean/std/threshold computation with generated metric distributions
    - Test empty corpus handling
    - _Requirements: 6.2_

- [x] 14. Self-improving loop — cloud failure analysis, coverage discovery, calibration
  - [x] 14.1 Implement failure analyzer module
  ...
  - [x] 14.2 Implement coverage discoverer module
  ...
  - [x] 14.3 Implement threshold calibrator module
  ...
  - [x] 14.4 Implement checklist evolver module
  ...
  - [x] 14.5 Write property tests for cloud analysis verdict routing
