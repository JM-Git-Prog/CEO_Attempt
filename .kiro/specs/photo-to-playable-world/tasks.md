...
- [ ] 1. Package structure, data models, and ComfyUI client
  - [ ] 1.1 Create photo_pipeline package structure and core data models
  ...
  - [ ] 1.2 Implement ComfyUI client (`src/photo_pipeline/comfyui_client.py`)
  ...
  - [ ] 1.3 Create ComfyUI workflow JSON templates
  ...
  - [ ] 1.4 Implement input validator (`src/photo_pipeline/input_validator.py`)
  ...
  - [ ] 1.5 Write property test for input validation (Property 1)
...
- [ ] 2. Scene Parsing — Segmentation and Inpainting
  - [ ] 2.1 Implement Scene Parser (`src/photo_pipeline/stages/scene_parser.py`)
  ...
  - [ ] 2.2 Write property test for mask area and count filtering (Property 2)
  ...
  - [ ] 2.3 Write property test for Object PNG extraction (Property 3)
...
- [ ] 3. Depth Estimation and Room Mesh Reconstruction
  - [ ] 3.1 Implement Depth Estimator (`src/photo_pipeline/stages/depth_estimator.py`)
...
- [ ] 6. Audio Synthesis
  ...
  - [ ] 6.2 Create sound bank assets (`assets/sound_bank/`)
...
- [ ] 7. Light Estimation, Scale Calibration, and Layout
  ...
  - [ ] 7.5 Implement Layout Estimator (`src/photo_pipeline/stages/layout_estimator.py`)
...
- [ ] 9. Collision Generation and LOD
  - [ ] 9.1 Implement Collision and LOD Generator (`src/photo_pipeline/stages/collision_lod.py`)
